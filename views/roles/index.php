                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col d-flex justify-content-between">
                            <h4 class="m-0">Gestión de Roles</h3>
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-md-7 d-flex justify-content-center justify-content-md-end">
                                            ...
                                            <?php if ($_SESSION['permisosMod']['rea']) { ?>
                                                <button type="button" class="btn bg-gradient-dark ml-2" onclick="window.open('<?= base_url() ?>/Roles/getReportRoles', '_blank')" title="Generar Reporte">
