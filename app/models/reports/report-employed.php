...
$empleados = $empleado->listarEmpleados("ROW_NUMBER() OVER (ORDER BY idempleado) N, cod_empleado Codigo, dni, concat(ap_paterno,' ',ap_materno,' ',nombres) Datos, telefono, area");
...
<body>
    <div class="contenedor">
            ...
            <table class="tabla_datos w-100">
                ...
                <tr>
                    <td>
                        ...
                        <p><b>Cantidad de <?php echo $entidad ?> : </b><?php echo count($empleados) ?></p>
                    </td>
                    <td>
        ...
        <br>
        <h2 class="title-detalle t1">DETALLE DE TABLA DE EMPLEADOS:</h2>
        <br>
...
$dompdf->stream('Reporte Empleados HACDP.pdf', array('Attachment' => false)); // Desactivamos descarga por defecto y nombre de archivo
exit;
